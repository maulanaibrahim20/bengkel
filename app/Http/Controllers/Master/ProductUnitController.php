    ...
    public function getDataTable(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                $editBtn = "<button type='button' class='btn br-7 btn-warning editBtn' data-id='{$row->id}' data-bs-toggle='modal' data-bs-target='#editModal'><i class='fa fa-edit'></i></button>";
