    ...
    public function getDataTable(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                $editBtn = "<a href='" . url("/super-admin/product/{$row->id}/edit") . "' class='btn btn-warning'><i class='fas fa-edit'></i></a>";

                $deleteBtn = "<button type='button' class='btn btn-danger deleteBtn' data-id='{$row->id}'><i class='fas fa-trash'></i></button>";
