...
@section('content')
    <div class="page-header bg-light rounded-3 shadow-sm mb-4 p-4">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title fw-bold text-primary mb-2">Profil Pengguna</h3>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ url('/super-admin/dashboard') }}"
                                class="text-decoration-none"><i class="fa fa-home me-1"></i>Beranda</a></li>
                    ...
                    <div class="p-4">
                        <div class="profile-image-wrap text-center position-relative" style="margin-top: -60px;">
                            <div class="profile-image mb-3">
                                ...
                                @endphp
                                <img src="{{ $imageUrl }}"
                                    class="rounded-circle img-fluid border border-4 border-white shadow" alt="Foto Profil"
                            ...
                            <div class="edit-profile-image position-absolute"
                                ...
                                <a href="#" data-bs-toggle="tooltip" title="Ubah Foto Profil">
                        ...
                        <div class="profile-info text-center mt-2">
                            ...
                            <div class="text-muted small mb-3">
                                <i class="fa fa-calendar-alt me-1"></i> Bergabung sejak
                        ...
                        <div class="profile-contact-info">
                            <h5 class="mb-3 fw-semibold text-primary"><i class="fa fa-address-card me-2"></i>Informasi
                                Kontak</h5>
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-3 d-flex align-items-center">
                                    ...
                                    <span>{{ $user->birth_date ?? 'Belum ditentukan' }}</span>
                                </li>
                                <li class="d-flex align-items-center">
                                    ...
                                    <span>{{ $user->address ?? 'Belum ditentukan' }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 mb-0">
                <div class="card-header bg-white d-flex justify-content-between align-items-center p-4 border-bottom">
                    <h5 class="card-title mb-0 fw-bold text-primary">
                        <i class="fa fa-user-circle me-2"></i>Informasi Profil
                    </h5>
                    <a href="#" class="btn btn-primary editBtn rounded-pill px-4" data-id="{{ $user->id }}">
                        <i class="fa fa-pencil me-2"></i>Ubah Profil
                    </a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="info-group mb-4 p-3 bg-light rounded-3">
                                <label class="d-block text-muted small mb-2 fw-semibold">Nama Lengkap</label>
                                <div class="info-value fs-5">{{ $user->name }}</div>
                            </div>

                            <div class="info-group mb-4 p-3 bg-light rounded-3">
                                <label class="d-block text-muted small mb-2 fw-semibold">Jenis Kelamin</label>
                                <div class="info-value fs-5">
                                    ...
                                    @else
                                        <i class="fa fa-genderless text-muted me-2"></i>Belum ditentukan
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="info-value fs-5">
                                    ...
                                    @else
                                        <span class="badge bg-danger-light text-danger py-2 px-3 rounded-pill">
                                            <i class="fa fa-times-circle me-2"></i>Tidak Aktif
                                        </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="info-group mb-4 p-3 bg-light rounded-3">
                                <label class="d-block text-muted small mb-2 fw-semibold">Terakhir Login</label>
                                <div class="info-value fs-5">
                                    <i class="fa fa-clock text-info me-2"></i>
                                    {{ $user->last_login_at ?? 'Tidak tersedia' }}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content rounded-4 border-0 shadow">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title"><i class="fa fa-edit me-2"></i>Ubah Informasi Profil</h5>
