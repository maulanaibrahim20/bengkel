...
@section('content')
    <div class="account-wrapper text-center">
        ...
        <div class="d-grid gap-3 mt-4">
            <a href="{{ url('/register/google/redirect') }}" class="btn btn-primary btn-lg rounded-pill">
                <i class="fab fa-google me-2"></i> Daftar Menggunakan Google
            </a>
            <a href="{{ url('register/phone/redirect') }}" class="btn btn-outline-primary btn-lg rounded-pill">
